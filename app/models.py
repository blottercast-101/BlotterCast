...
class BlotterRecord(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            "complainant_addr": self.complainant_addr or "",
            "respondent": self.respondent or "",
            "respondent_id": self.respondent_id,
            "respondent_addr": self.respondent_addr or "",
            "nature": self.nature or "",
            "narrative": self.narrative or "",
            "case_type": self.case_type or "CRIM",
